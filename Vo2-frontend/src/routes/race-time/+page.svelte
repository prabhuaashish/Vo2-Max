    ...
    <form class="calc-form" id="calc-form">
        <div class="form-fields">
            <div class="field-outer col-1">
                <label for="r-time-m" class="top-label">Goal Race:</label>
            ...
            <div class="field-outer">
                <label for="time-h" class="top-label"><span class="m-hide">Recent </span>Race Time:</label>
                <div class="field-items">
                    <div class="field">
            ...
            <div class="field-outer col-2">
                <label for="r1" class="top-label">Another Race: <span class="small">(Optional)</span></label>
                <div class="field-items">
                    <div class="field field-large">
            ...
            <div class="field-outer">
                <label for="time-h" class="top-label"><span class="m-hide">Another </span>Race Time: <span class="small">(Optional)</span></label>
                <div class="field-items">
                    <div class="field">
            ...
            <div class="field-outer col-large">
                <label for="r-pace-m" class="top-label">Mi/Km run per week:</label>
                <div class="field-items">
                    <div class="field">
